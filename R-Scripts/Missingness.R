...
# Create a copy of the covariates to simulate missing at random (mar) and not
...
# Add missingness to the existing data. For the not missing at random data treatment
# units will have twice as many missing values as the control group.
set.seed(2112)
