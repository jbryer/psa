...
```{r intro-balance-plots, echo=FALSE, fig.cap = 'Multiple (left) and continuous (right) covariate balance assessment plots', fig.show='hold', out.width='50%'}
PSAgraphics::cv.bal.psa(covariates = dat[,c('x1','x2')],
						treatment = dat$treatment,
						propensity = dat$ps, 
						strata = 5)
strata5 <- as.numeric(cut(dat$ps, quantile(dat$ps, seq(0, 1, 1/5)),
