...
ggplot() +
	...
	geom_segment(data = strata5_out, aes(x = xmin, xend = xmax, y = mean, yend = mean, color = treatment), size = 1) +
...
```{r intro-circ-psa, echo=FALSE, results='hide', fig.cap='Propensity score assessment plot for five strata'}
