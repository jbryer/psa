...
* Bootstrapping was first introduced by Efron (1979) in [*Bootstrap Methods: Another Look at the Jackknife*](https://projecteuclid.org/euclid.aos/1176344552).
...
Rosenbaum (2012) suggested that one way to test for sensitivity of model selection is to [test the null hypothesis twice](https://www.jstor.org/stable/41720732).
...
[`r icons::fontawesome("link")` psa.bryer.org](https://psa.bryer.org)  
