...
##  P boot            1.3-28.1 2022-11-22 [3] CRAN (R 4.3.0)
##  P bslib           0.4.2    2022-12-16 [?] RSPM (R 4.3.0)
##  P cachem          1.0.7    2023-02-24 [?] RSPM (R 4.3.0)
##  P callr           3.7.3    2022-11-02 [?] RSPM (R 4.3.0)
##    car           * 3.1-2    2023-03-30 [1] CRAN (R 4.3.0)
##    carData       * 3.0-5    2022-01-06 [1] CRAN (R 4.3.0)
##  P cli             3.6.1    2023-03-23 [?] RSPM (R 4.3.0)
##  P codetools       0.2-19   2023-02-01 [3] CRAN (R 4.3.0)
...
##    granova       * 2.2      2023-03-22 [1] CRAN (R 4.3.0)
##  P granovaGG     * 1.4.0    2015-12-18 [?] RSPM (R 4.3.0)
...
##  P httpuv          1.6.9    2023-02-14 [?] RSPM (R 4.3.0)
##  P jquerylib       0.1.4    2021-04-26 [?] RSPM (R 4.3.0)
##  P jsonlite        1.8.4    2022-12-06 [?] RSPM (R 4.3.0)
##  P knitr         * 1.42     2023-01-25 [?] RSPM (R 4.3.0)
##  P later           1.3.0    2021-08-18 [?] RSPM (R 4.3.0)
##  P lattice         0.21-8   2023-04-05 [3] CRAN (R 4.3.0)
...
##  P MASS          * 7.3-58.4 2023-03-07 [3] CRAN (R 4.3.0)
##    Matching      * 4.10-8   2022-11-03 [1] CRAN (R 4.3.0)
##    MatchIt       * 4.5.3    2023-04-13 [1] CRAN (R 4.3.0)
##  P Matrix          1.5-4    2023-04-04 [3] CRAN (R 4.3.0)
##    matrixStats     0.63.0   2022-11-18 [1] CRAN (R 4.3.0)
##  P memoise         2.0.1    2021-11-26 [?] RSPM (R 4.3.0)
##  P mgcv            1.8-42   2023-03-02 [3] CRAN (R 4.3.0)
...
##    multilevelPSA * 1.2.5    2018-03-22 [1] CRAN (R 4.3.0)
##  P munsell         0.5.0    2018-06-12 [?] RSPM (R 4.3.0)
##    mvtnorm         1.1-3    2021-10-08 [1] CRAN (R 4.3.0)
##  P nlme            3.1-162  2023-01-31 [3] CRAN (R 4.3.0)
##    nloptr          2.0.3    2022-05-26 [1] CRAN (R 4.3.0)
##    party           1.3-13   2023-03-17 [1] CRAN (R 4.3.0)
##  P pillar          1.9.0    2023-03-22 [?] RSPM (R 4.3.0)
##  P pkgbuild        1.4.0    2022-11-27 [?] RSPM (R 4.3.0)
##  P pkgconfig       2.0.3    2019-09-22 [?] RSPM (R 4.3.0)
##  P pkgload         1.3.2    2022-11-16 [?] RSPM (R 4.3.0)
##  P plyr            1.8.8    2022-11-11 [?] RSPM (R 4.3.0)
##  P prettyunits     1.1.1    2020-01-24 [?] RSPM (R 4.3.0)
##  P processx        3.8.1    2023-04-18 [?] RSPM (R 4.3.0)
##  P profvis         0.3.7    2020-11-02 [?] RSPM (R 4.3.0)
##  P promises        1.2.0.1  2021-02-11 [?] RSPM (R 4.3.0)
##  P ps              1.7.5    2023-04-18 [?] RSPM (R 4.3.0)
##    PSAboot       * 1.3.6    2023-03-22 [1] CRAN (R 4.3.0)
##    PSAgraphics   * 2.1.2    2023-03-21 [1] CRAN (R 4.3.0)
##    psych           2.3.3    2023-03-18 [1] CRAN (R 4.3.0)
##  P purrr           1.0.1    2023-01-10 [?] RSPM (R 4.3.0)
##  P R6              2.5.1    2021-08-19 [?] RSPM (R 4.3.0)
##  P randomForest    4.7-1.1  2022-05-23 [?] RSPM (R 4.3.0)
##  P RColorBrewer    1.1-3    2022-04-03 [?] RSPM (R 4.3.0)
##  P Rcpp            1.0.10   2023-01-22 [?] RSPM (R 4.3.0)
##  P remotes         2.4.2    2021-11-30 [?] RSPM (R 4.3.0)
##    reshape         0.8.9    2022-04-12 [1] CRAN (R 4.3.0)
##  P reshape2      * 1.4.4    2020-04-09 [?] RSPM (R 4.3.0)
##  P rlang           1.1.0    2023-03-14 [?] RSPM (R 4.3.0)
##  P rmarkdown       2.21     2023-03-26 [?] RSPM (R 4.3.0)
##  P rpart         * 4.1.19   2022-10-21 [3] CRAN (R 4.3.0)
##    sandwich        3.0-2    2022-06-15 [1] CRAN (R 4.3.0)
##  P sass            0.4.5    2023-01-24 [?] RSPM (R 4.3.0)
##  P scales        * 1.2.1    2022-08-20 [?] RSPM (R 4.3.0)
##  P sessioninfo     1.2.2    2021-12-06 [?] RSPM (R 4.3.0)
##  P shiny           1.7.4    2022-12-15 [?] RSPM (R 4.3.0)
