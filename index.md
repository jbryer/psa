...
##  P boot            1.3-28.1 2022-11-22 [3] CRAN (R 4.3.1)
##  P bslib           0.5.0    2023-06-09 [?] RSPM (R 4.3.0)
...
##  P codetools       0.2-19   2023-02-01 [3] CRAN (R 4.3.1)
...
##  P digest          0.6.32   2023-06-26 [?] RSPM (R 4.3.0)
...
##    granova       * 2.2      2023-03-22 [1] CRAN (R 4.3.1)
...
##    multilevelPSA * 1.2.5    2018-03-22 [1] CRAN (R 4.3.1)
##  P munsell         0.5.0    2018-06-12 [?] RSPM (R 4.3.0)
##    mvtnorm         1.2-2    2023-06-08 [1] CRAN (R 4.3.1)
##  P nlme            3.1-162  2023-01-31 [3] CRAN (R 4.3.1)
##  P nloptr          2.0.3    2022-05-26 [?] RSPM (R 4.3.0)
...
##    PSAboot       * 1.3.6    2023-03-22 [1] CRAN (R 4.3.1)
##    PSAgraphics   * 2.1.2    2023-03-21 [1] CRAN (R 4.3.1)
...
##  P rpart         * 4.1.19   2022-10-21 [3] CRAN (R 4.3.1)
##  P rstudioapi      0.14     2022-08-22 [?] RSPM (R 4.3.0)
##    sandwich        3.0-2    2022-06-15 [1] CRAN (R 4.3.1)
##  P sass            0.4.6    2023-05-03 [?] RSPM (R 4.3.0)
...
##  P xml2            1.3.4    2023-04-27 [?] RSPM (R 4.3.0)
